    ...
    public partial class MainWindow : Window
    {
        ...
        */
        ...
        private void Window_Closed(object sender, EventArgs e)
        {
            ...
            {
                vKeyboard.ProcessCommand(current.KBCommand, new bool?(true));
            }
        }
        private void keyboard_Click(object sender, RoutedEventArgs e)
        {
            bool flag = vLayout.keyboard == "Keyboard";
            if (flag)
            {
                vLayout.Load("Numpad", this.mainContainer, this);
            }
            else
            {
                vLayout.Load("Keyboard", this.mainContainer, this);
            }
        }
